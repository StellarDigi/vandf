...
if( ! class_exists( 'avia_sc_testimonial', false ) )
{
	class avia_sc_testimonial extends aviaShortcodeTemplate
	{
		...
		protected function register_modal_group_templates()
		{
			 ...
			 * @return array
			 */
			$dynamic = apply_filters( 'avf_dynamic_dropdown_array', [ 'wp_custom_field' ], 'avia_sc::link', $this );
		...
		protected function get_element_styles_item( array $args )
		{
			...
			if( ! empty( $atts['src_dynamic'] ) )
			{
				$atts['src'] = $atts['src_dynamic'];
			}
...
//			}
		...
		public function av_testimonial_single( $atts, $content = '', $shortcodename = '' )
		{
			...
			if( in_array( trim( $link ), [ '', 'http://', 'https://' ] ) )
			{
				$link = '';
			}
